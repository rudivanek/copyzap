...
const CopyOutput: React.FC<CopyOutputProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-5">
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-400 dark:text-gray-500 flex items-center space-x-2 mt-0.5">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-md p-4 custom-scrollbar">
        <FormattedContent content={content} className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed" />
      </div>
    </div>
  );
};
